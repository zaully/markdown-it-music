...
const CHORD_PATTERN = new RegExp(
  [
    ...
    "([CDEFGAB](?:#|b)?|N.C.)",
    "(",
    "maj|maj7|maj9|maj11|maj13|maj9#11|maj13#11|add9|maj7b5|maj7#5|maj7-5|",
    "△|△7|△9|△11|△13|△9#11|△13#11|△7b5|△7#5|△7-5|",
    "m|m7|m9|m9/6|m11|m13|m6|madd9|m6add9|m7add9|mmaj7|mmaj9|m7b5|m7#5|m7-5|",
    "5|",
    "6|6/9|",
    "7|7/6|7sus4|7b5|7#5|ø|7b9|7#9|7b5b9|7b5#9|7#5b9|7b9#5|7-5|",
    "7aug|7aug5|7aug9|7dim5|7dim9|7sus2|7sus4|",
    "9|9/6|9b5|9#5|9aug5|9dim5|9sus|9sus4|9-5|",
...
class Chord {
  constructor(root, quality, bass, duration, dotted) {
    this.root = root;
  ...
  aliases() {
    ...
    return rootAliases.flatMap((root) =>
      bassAliases.map((bass) => new Chord(root, this.quality, bass, this.duration, this.dotted)),
    );
  }
}
...
function parseChord(str) {
  ...
  return new Chord(tokens[2], tokens[3], tokens[4], tokens[1], tokens[5]);
}
